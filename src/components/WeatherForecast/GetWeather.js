...
function GetWeather(props) {
  ...
  const getData = () => {
    ...
    let url = "https://api.open-meteo.com/v1/forecast?latitude="+latitude+"&longitude="+longitude+"&daily=weathercode,temperature_2m_max,rain_sum,snowfall_sum,windspeed_10m_max&forecast_days=3&start_date="+today+"&end_date="+futureDate+"&timezone=auto"
